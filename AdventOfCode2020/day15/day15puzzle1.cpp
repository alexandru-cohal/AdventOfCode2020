#include "day15puzzle1.h"

void mainDay15Puzzle1()
{
	vector<int> starting;
	readInputsDay15Puzzle1(starting);

	cout << solveDay15Puzzle1(starting);
}

void readInputsDay15Puzzle1(vector<int>& starting)
{
...
int solveDay15Puzzle1(vector<int> starting)
{
	...
	// Iterate over all the turns until the 2020th turn
	for (int turn = (int)starting.size() + 1; turn <= 2020; turn++)
	{
		int currentNumber;
